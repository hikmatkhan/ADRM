...
class WA(BaseLearner):
    def __init__(self, args):
        ...
        init_epoch = args["wa_init_epoch"]
        init_lr = args["wa_init_lr"]
        init_lr_decay = args["wa_init_lr_decay"]
        init_weight_decay = args["wa_init_weight_decay"]
        epochs = args["wa_epochs"]
        lrate = args["wa_lrate"]
        lrate_decay = args["wa_lrate_decay"]
        weight_decay = args["wa_weight_decay"]
        T = args["wa_T"]
        batch_size = args["wa_batch_size"]
        super().__init__(args)
