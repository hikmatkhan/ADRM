...
class PODNet(BaseLearner):
    def __init__(self, args):
        global epochs, lrate, ft_epochs, ft_lrate, batch_size, lambda_c_base, lambda_f_base, nb_proxy, weight_decay, batch_size

        epochs = args["pd_epochs"]
        lrate = args["pd_lrate"]
        weight_decay = args["pd_weight_decay"]
        ft_epochs = args["pd_ft_epochs"]
        batch_size = args["pd_batch_size"]
        lambda_c_base = args["pd_lambda_c_base"]
        lambda_f_base = args["pd_lambda_f_base"]
        nb_proxy = args["pd_nb_proxy"]
