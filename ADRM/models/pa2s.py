...
class PASS(BaseLearner):
    def __init__(self, args):
        super().__init__(args)
        self.args = args
        self.args["temp"] = args["pass_temp"]
        self.args["epochs"] = args["pass_epochs"]
        self.args["lr"] = args["pass_lr"]
        self.args["batch_size"] = args["pass_batch_size"]
        self.args["weight_decay"] = args["pass_weight_decay"]
        self.args["step_size"] = args["pass_step_size"]
        self.args["gamma"] = args["pass_gamma"]
        self.args["T"] = args["pass_T"]
    ...
    def after_task(self):
        ...
        self.passnet_save_checkpoint("{}_{}_{}".format(self.args["model_name"],self.args["init_cls"], self.args["increment"]))
