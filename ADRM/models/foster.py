...
class FOSTER(BaseLearner):
    def __init__(self, args):
        ...
        self.args = args
        # Added for wandb
        self.args["init_epochs"] = args["foster_init_epochs"]
        self.args["init_lr"] = args["foster_init_lr"]
        self.args["init_epochs"] = args["foster_init_epochs"]
        self.args["init_weight_decay"] = args["foster_init_weight_decay"]
        self.args["compression_epochs"] = args["foster_compression_epochs"]
        self.args["batch_size"] = args["foster_batch_size"]
        self.args["lr"] = args["foster_lr"]
        self.args["weight_decay"] = args["foster_weight_decay"]
        self.args["boosting_epochs"] = args["foster_boosting_epochs"]
        self.args["T"] = args["foster_T"]
        self._network = FOSTERNet(self.args, False)
        self._snet = None
        self.beta1 = self.args["beta1"]
        self.beta2 = self.args["beta2"]
        self.per_cls_weights = None
        self.is_teacher_wa = self.args["is_teacher_wa"]
        self.is_student_wa = self.args["is_student_wa"]
        self.lambda_okd = self.args["lambda_okd"]
        self.wa_value = self.args["wa_value"]
        self.oofc = self.args["oofc"].lower()
    ...
    def _feature_compression(self, train_loader, test_loader):
        ...
        logging.info("CNN top2 curve: {}".format(cnn_accy["top{}".format(self.args["topk"])]))
