...
class IL2A(BaseLearner):
    def __init__(self, args):
        super().__init__(args)
        self.args = args
        self.args["epochs"] = args["il2a_epochs"]
        self.args["lr"] = args["il2a_lr"]
        self.args["batch_size"] = args["il2a_batch_size"]
        self.args["weight_decay"] = args["il2a_weight_decay"]
        self.args["T"] = args["il2a_T"]
    ...
    def after_task(self):
        ...
        self.il2a_save_checkpoint("{}_{}_{}".format(self.args["model_name"],self.args["init_cls"],self.args["increment"]))
