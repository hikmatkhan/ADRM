...
class DER(BaseLearner):
    def __init__(self, args):
        global lrate, lrate_decay, weight_decay, T, init_lr, init_weight_decay, init_lr_decay, epochs, init_epoch, batch_size
        init_epoch = args["der_init_epoch"]
        epochs = args["der_epochs"]
        lrate = args["der_lrate"]
        lrate_decay = args["der_lrate_decay"]
        weight_decay = args["der_weight_decay"]
        T = args["der_T"]
        init_lr = args["der_init_lr"]
        init_weight_decay = args["der_init_weight_decay"]
        init_lr_decay = args["der_init_lr_decay"]
        batch_size = args["der_batch_size"]
        super().__init__(args)
