...
class BiC(BaseLearner):
    def __init__(self, args):
        global epochs, lrate, lrate_decay, batch_size, split_ratio, T, weight_decay
        epochs = args["bic_epochs"]
        lrate = args["bic_lrate"]
        lrate_decay = args["bic_lrate_decay"]
        batch_size = args["bic_batch_size"]
        split_ratio = args["bic_split_ratio"]
        T = args["bic_T"]
        weight_decay = args["bic_weight_decay"]
